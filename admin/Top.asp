...
<title>Haker：深夜网络后台管理 QQ:2503516940</title>
  ...
  <table width="100%" height="26"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#B6E6FB">
    <tr>
      <td height="25" colspan="2" background="images/bg1.png"><table width="100%" border="0">
        <tr>
          <td><div align="left"><span class="STYLE3"><strong>&nbsp;深夜网络后台管理中心</strong></span></div></td>
    ...
    <tr>
      <td bgcolor="white"><div align="center"><span class="STYLE3">注意：该程序请勿非法使用,仅供学习! 深夜 QQ:2503516940 </span> </div></td>
    </tr>
  </table>
</div>
</body>
